...
barragem = pd.read_csv('https://raw.githubusercontent.com/gustavoramos82/codigo-carioca/main/Dataset/dataframe%20usado%20no%20streamlit.csv',encoding='latin1')
